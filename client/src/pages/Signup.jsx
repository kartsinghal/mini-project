...
// ⚠️ CRITICAL: Field must be defined OUTSIDE Signup to prevent remount on every keystroke
      ...
      >
        ...
        <div style={{
          ...
          <p style={{ margin: '0 0 28px', fontSize: 14, color: muted }}>
            Join HealthLens — your AI health companion
          </p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              {pw.length > 0 && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ fontSize: 11, color: strengthColor[strength], fontWeight: 600, minWidth: 36 }}>
            ...
            {/* Perks */}
            <div style={{ display: 'flex', gap: 16, padding: '10px 0', borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}` }}>
              {['Free forever', 'AI-powered', 'Private & secure'].map((t) => (
                <span key={t} style={{ fontSize: 11, color: muted, display: 'flex', alignItems: 'center', gap: 4 }}>
                  <CheckCircle2 size={11} color={teal} /> {t}
                </span>
              ))}
            </div>
